...
WP4_IMPLEMENTED = {
    ...
    "IDIOPT1": "Diag option switch read; recorded on meta / METLST.",
    "IDIOPT2": "Diag option switch read; recorded on meta / METLST.",
    "IDIOPT3": "Diag option switch read; recorded on meta / METLST.",
    "IDIOPT4": "Diag option switch read; recorded on meta / METLST.",
    "IDIOPT5": "Diag option switch read; recorded on meta / METLST.",
    "ZUPT": "Upper T reference height read; recorded on meta.",
    "IUPWND": "Upper wind station index read; recorded on meta.",
    "ZUPWND": "Upper wind height range read; recorded on meta.",
    ...
    "IMIXH": "±1 Maul–Carson (wired); ±3 Holzworth intercept; ±2 still NotImplemented.",
